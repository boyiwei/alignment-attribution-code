...
def apply_prompt_template(prompt_template_style='base', dataset=None, prefix="", include_inst=True, gcg_suffix_id=3):
    ...
    for prompt in dataset:
        if include_inst:
            if gcg_suffix_id == 3:
                ...
                prompt = B_INST + " " + (PROMPT_TEMPLATE % (prefix + prompt)).strip() + " " + gcg_list[gcg_suffix_id] + " " + E_INST
        else:
